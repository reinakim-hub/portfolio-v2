...
const SECTIONS = [
  { id: "brand-foundations", label: "Understanding brand foundations" },
  { id: "visual-language", label: "Setting the visual language" },
  { id: "microsite-experience", label: "Crafting the microsite experience" },
  { id: "pushing-forward", label: "Pushing the design forward" },
  { id: "balancing-emotion", label: "Balancing emotion with functionality" },
            ...
            <Reveal>
              <section id="visual-language" className="scroll-mt-24">
                ...
                <div className="mt-8">
                  <ImageGallery
                    images={[
                      ...
                      {
                        src: "/images/ssfb-poster-2.webp",
                        alt: "Blue festival poster with a portrait photo",
                        width: 612,
                        height: 792,
                      },
                      {
                        src: "/images/ssfb-poster-3.webp",
                        alt: "Green festival poster with black geometric shapes",
                        width: 612,
                        height: 792,
                      },
                      {
                        src: "/images/ssfb-poster-4.webp",
                        alt: "Black and green festival poster with a portrait photo",
                        width: 612,
                        height: 792,
                      },
                    ]}
                ...
                <div className="mt-8 max-w-prose space-y-4 text-body">
                  ...
                  <p>
                    Degular is a versatile font with bold stroke width and
                    curvature. We wanted to use bold, rounded typeface that
                    could fill in the space within our frames. To contrast
                    the boldness of Degular, we used JetBrains Mono, to
                    maintain legibility to balance the two typefaces.
                  </p>
                  <p>
                    As we wanted to use typography and framing shapes as our
                    focal point, we decided to turn our images greyscale and
                    added grain and noise. This way, the images blend into
                    the composition without taking away from the
                    typography.
                  </p>
                  <p>
                    We used vibrant green to capture attention and highlight
                ...
                <div className="mt-8">
                  <ImageGallery
                    images={[
                      {
                        src: "/images/ssfb-collage.webp",
                        alt: "Green duotone photo collage with festival date and location details",
                        width: 612,
                        height: 792,
                      },
                      {
                        src: "/images/ssfb-banner-street.webp",
                        alt: "Street banners reading See Hear Feel and Strange Sounds From Beyond in Amsterdam",
                        width: 1091,
                        height: 696,
                      },
                      {
                        src: "/images/ssfb-banner-pole.webp",
                        alt: "Street banners reading Strange Sounds From Beyond and June 22 2019",
                        width: 603,
                        height: 696,
                      },
                      {
                        src: "/images/ssfb-banner-museum.webp",
                        alt: "Strange Sounds From Beyond banner mockup on the Rijksmuseum facade",
                        width: 1127,
                        height: 698,
                      },
                    ]}
              ...
              <section id="balancing-emotion" className="scroll-mt-24">
                ...
                <div className="mt-8">
                  <ImageGallery
                    images={[
                      {
                        src: "/images/ssfb-artist-list.webp",
                        alt: "Artist selection list with Lulu & Mata Hari highlighted and album art shown",
                        width: 1920,
                        height: 1080,
                      },
                      {
                        src: "/images/ssfb-ticket-purchase.webp",
                        alt: "Ticket purchase screen with price, quantity, and payment fields",
                        width: 1042,
                        height: 585,
                      },
                    ]}

...
const SECTIONS = [
  { id: "problem-space", label: "Identifying the problem space" },
  { id: "selecting-client", label: "Selecting the client" },
  { id: "value-to-stakeholders", label: "Value to stakeholders" },
  { id: "design-sprints", label: "Design sprints" },
  { id: "user-testing", label: "Participants didn’t like it!" },
  { id: "pivot", label: "So we went back and pivoted" },
  { id: "user-needs", label: "Understanding the real user needs" },
  { id: "reiterating-value", label: "Reiterating value to both stakeholders" },
  { id: "final-presentation", label: "Final presentation and key takeaways" },
      ...
      middle={
        <>
          ...
          {/* Introduction — same copy as before, now wrapped to match
              ...
              of being immediately visible alongside the hero. */}
                ...
                <ProseColumn className="border-t border-rule pt-10">
                  ...
                  <div className="copy-body mt-4 space-y-4 text-body">
                    <p>
                      ...
                      this as an opportunity to introduce a digital solution
                      that offers accessible resources, helping immigrants
                      better prepare for the financial landscape ahead of
                      their arrival.
                    </p>
                    <p>
                      Additionally, Simplii Financial&rsquo;s target
                      audience aligns with the majority of immigrants, who
              ...
              <section id="user-needs" className="scroll-mt-24">
                ...
                <ProseColumn className="copy-body mt-8 space-y-4 text-body">
                  <p>
                    ...
                    participants. It was designed to showcase stories of
                    Canadian newcomers and their financial journeys.
                  </p>
                  <p>
                    We expanded on this idea to foster relatability and
